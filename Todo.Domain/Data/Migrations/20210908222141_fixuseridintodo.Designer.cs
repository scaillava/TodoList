...
namespace Todo.Domain.Data.Migrations
{
    ...
    [Migration("20210908222141_fixuseridintodo")]
    partial class fixuseridintodo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Todo.Domain.Models.TodoTask", b =>
                {
                    ...
                    b.HasIndex("Id", "TodoId");

                    b.ToTable("TodoTaskEntity");
                });

            modelBuilder.Entity("Todo.Domain.Models.UserToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Todo.Domain.Models.Todo", b =>
                {
                    b.HasOne("Todo.Domain.ApplicationUser", "AspNetUser")
                        .WithMany()
